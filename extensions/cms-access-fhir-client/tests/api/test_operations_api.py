...
class TestSubmitEligibility:
    ...
    def test_creates_alignment_on_success(self):
        ...
        with (
            ...
            patch(
                "cms_access_fhir_client.api.operations_api.check_eligibility"
            ) as mock_check,
            patch(
                "cms_access_fhir_client.api.operations_api.ACCESSAlignment.objects"
...
class TestSubmitAlign:
    ...
    def test_creates_alignment_on_success(self):
        ...
        with (
            ...
            patch(
                "cms_access_fhir_client.api.operations_api.align"
            ) as mock_align,
            patch(
                "cms_access_fhir_client.api.operations_api.ACCESSAlignment.objects"
            ) as mock_alignment_objects,
...
class TestSubmitUnalign:
    ...
    def test_submits_unalign_on_success(self):
        ...
        with (
            ...
            patch(
                "cms_access_fhir_client.api.operations_api.unalign"
            ) as mock_unalign,
        ):
            mock_patient_objects.get.return_value = mock_patient
            mock_alignment_objects.filter.return_value.order_by.return_value.first.return_value = mock_alignment
