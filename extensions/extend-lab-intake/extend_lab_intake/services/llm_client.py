"""Anthropic Claude LLM client for patient matching and summarization."""
...
class LLMClient:
    """Anthropic Claude LLM client for lab intake operations.

    Used for:
    - Patient matching from extracted demographics
    ...
    def chat(
        self, system_prompt: str | None = None, user_prompt: str | None = None
    ) -> dict[str, Any]:
        ...
        Returns:
            dict with keys: success, content, error, status_code
        """
        if system_prompt:
    ...
    def chat_with_json(
        ...
        """Send a chat request expecting JSON response with automatic retry.
