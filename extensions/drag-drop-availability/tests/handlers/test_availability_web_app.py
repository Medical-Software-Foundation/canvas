...
from drag_drop_availability.handlers.availability_web_app import (
    AvailabilityWebApp,
...
def test_index_returns_html_response():
    ...
    with patch(
        "drag_drop_availability.handlers.availability_web_app.Staff"
    ) as mock_staff, patch(
        "drag_drop_availability.handlers.availability_web_app.PracticeLocation"
    ) as mock_loc, patch(
        "drag_drop_availability.handlers.availability_web_app.NoteType"
    ) as mock_nt, patch(
        "drag_drop_availability.handlers.availability_web_app.Event"
    ) as mock_event_cls, patch(
        "drag_drop_availability.handlers.availability_web_app.render_to_string",
        return_value="<html>",
    ), patch(
        "drag_drop_availability.handlers.availability_web_app._serialize_event",
