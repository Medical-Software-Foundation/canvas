"""Register the 'Last Reviewed' custom section in the patient chart summary.
...
configuration event with a list that includes our CustomSection.
"""
...
SECTION_KEY = "last_reviewed_summary"


class LastReviewedSectionConfig(BaseHandler):
    """Adds the 'Last Reviewed' custom section to the patient chart summary."""
