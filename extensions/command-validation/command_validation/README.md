...
This plugin responds to `QUESTIONNAIRE_COMMAND__PRE_COMMIT`, which fires before a questionnaire command is committed. Returning an `EventValidationError` effect blocks the commit and displays the error to the user.
