...
from intake_agent.llms.llm_openai import LlmOpenai
...
class TestLlmOpenai(unittest.TestCase):
    ...
    @patch("intake_agent.llms.llm_openai.requests.post")
...
```"""
    ...
    def test_chat_with_json_resets_messages(self):
        ...
        with patch("intake_agent.llms.llm_openai.requests.post") as mock_post:
            mock_response = Mock()
            mock_response.status_code = HTTPStatus.OK
            mock_response.json.return_value = {
                "choices": [
