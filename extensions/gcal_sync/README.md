...
| `INGEST_ALL_DAY_EVENTS` | Optional, default false. Import all-day Google events as holds. A multi-day all-day event (PTO, OOO) becomes one hold per covered day, so every day it spans is blocked. |
