...
if __name__ == '__main__':
    ...
    loader = PatientLoader(environment='phi-test-accomplish')
    delimiter = ','
    ...
    loader.load(valid_rows, system_unique_identifier='enterpriseid')

    #loader.fumage_helper.build_patient_external_identifier_map("enterpriseid", "PHI/patient_id_map.json")